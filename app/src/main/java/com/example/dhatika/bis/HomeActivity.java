...
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button ton1 = findViewById(R.id.button1);
...
//	TODO Auto-generated method stub
                Intent inte2 = new Intent(HomeActivity.this, TambahCatatan.class); startActivity(inte2);
            }
    ...
    public void RefreshList(){
        ...
        cursor = db.rawQuery("SELECT id_catatan,tgl_catatan,judul_catatan,isi_catatan FROM catatan",null);
...
//.getItemAtPosition(arg2).toString();
               ...
               /* final String selection2 = daftar2[arg2];*/
                final CharSequence[] dialogitem = {"Lihat Data Catatan", "Ubah Catatan", "Hapus"};
...

                {
                    ...
                    public void onClick(DialogInterface dialog, int item) { switch(item){
                        ...
                        case 0 :
                            Intent i = new Intent(getApplicationContext(), DaftarCatatan.class);
                        ...
                        case 2 :
                            ...
                            db.execSQL("delete from catatan where judul_catatan = '"+selection+"'");
                            RefreshList();
                            break;
